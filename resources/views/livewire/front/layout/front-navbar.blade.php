<div>
    ...
    <header class="d-lg-none bg-white w-100"><!-- start responsive header-->
        <div class="container">
            <div class="row py-2">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" data-bs-scroll="true" id="mobile-menu"><!-- start mobile menu-->
                        ...
                        <div class="offcanvas-body px-0">
                            ...
                            <div class="input-group search-box px-3"><!-- start search box -->
                                ...
                                <button type="submit" class="btn btn-danger"><img src="assets/images/search.png"></button>
                            </div><!-- end search box -->
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" data-bs-scroll="true" id="shopping-cart-responsive"><!-- start shopping cart offcanvas -->
                        ...
                        <div class="offcanvas-body"><!-- start cart body --><!- https://t.me/sabzrea ->
                            ...
                            <div class="row"><!-- start cart item -->
                                <div class="col-4"><img src="assets/images/mobile1.jpg" class="img-fluid img-thumbnail"></div>
                            ...
                            <div class="row"><!-- start cart item -->
                                <div class="col-4"><img src="assets/images/mobile2.jpg" class="img-fluid img-thumbnail"></div>
                                <div class="col-8 d-flex align-items-center">
                                    <a href="product.html" class="cart-product-title">گوشی موبایل سامسونگ مدل Galaxy A21S SM-A217F/DS</a>
                                </div>
                            </div>
                            ...
                            <div class="row"><!-- start cart item -->
                                <div class="col-4"><img src="assets/images/mobile3.jpg" class="img-fluid img-thumbnail"></div>
                                <div class="col-8 d-flex align-items-center">
                                    <a href="product.html" class="cart-product-title">گوشی موبایل سامسونگ مدل Galaxy A21S SM-A217F/DS</a>
                                </div>
                            </div>
