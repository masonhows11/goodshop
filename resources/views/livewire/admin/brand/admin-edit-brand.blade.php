<div>
    ...
    <div class="container-fluid">
        ...
        <form wire:submit.prevent="update">
            @csrf
            <div class="row  mt-5 edit-form-brand">
                ...
                <div class="col-sm-4">
                    <div class="mb-3 mt-3">
                        @if ($logo)
                            <img src="{{ $logo->temporaryUrl() }}" width="200" height="200" alt="brand_photo"
                                class="rounded border border-2 image-admin-preview">
                        @else
                            @if ($brand_logo)
                                <img src="{{ asset('storage/images/' . $brand_logo) }}" width="200" height="200"
                                    alt="brand_photo" class="rounded border border-2 image-admin-preview">
                            @else
                                <img src="{{ asset('dash/images/no-image-icon-23494.png') }}" width="200" height="200"
                                    alt="brand_photo" class="rounded border border-2 image-admin-preview">
                            @endif
                        @endif
                    </div>
